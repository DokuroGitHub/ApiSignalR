...
namespace Application.Hubs.ConversationInvitations;

public class ConversationInvitationsHub : Hub // treat this as a Controller
{
    private ISender _mediator;

    public ConversationInvitationsHub(ISender mediator)
    {
        _mediator = mediator;
    }
